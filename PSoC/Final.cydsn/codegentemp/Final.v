...
// UART_v2_50(Address1=0, Address2=0, BaudRate=115200, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, Enable_RX=1, Enable_RXIntInterrupt=0, Enable_TX=1, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=false, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=true, InternalClock=true, InternalClockToleranceMinus=3.93736842105263, InternalClockTolerancePlus=3.93736842105263, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=1, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=false, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=true, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=921600, RXAddressMode=0, RXBufferSize=4, RxBuffRegSizeReplacementString=uint8, RXEnable=true, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=true, Use23Polling=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=UART_v2_50, CY_CONFIG_TITLE=UART_4, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UART_4, CY_INSTANCE_SHORT_NAME=UART_4, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=UART_4, )
module UART_v2_50_2 (
    clock,
    cts_n,
    reset,
...
module top ;
	...
	wire [0:0] tmpOE__Rx_4_net;
	wire [0:0] tmpIO_0__Rx_4_net;
	wire [0:0] tmpINTERRUPT_0__Rx_4_net;
	electrical [0:0] tmpSIOVREF__Rx_4_net;
	...
	cy_psoc3_pins_v1_10
		...
		Rx_4
		 (.oe(tmpOE__Rx_4_net),
		  .y({1'b0}),
		  .fb({Net_4317}),
		  .io({tmpIO_0__Rx_4_net[0:0]}),
		  .siovref(tmpSIOVREF__Rx_4_net),
		  .interrupt({tmpINTERRUPT_0__Rx_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rx_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_2 UART_4 (
        ...
        .rx_clk(Net_4322),
        .rx_data(Net_4323),
        .rx_interrupt(Net_4324),
        .tx(Net_4313),
        .tx_clk(Net_4325),
        .tx_data(Net_4326),
        .tx_en(Net_4327),
        .tx_interrupt(Net_4328));
    defparam UART_4.Address1 = 0;
    defparam UART_4.Address2 = 0;
    defparam UART_4.EnIntRXInterrupt = 0;
    defparam UART_4.EnIntTXInterrupt = 0;
    defparam UART_4.FlowControl = 0;
    defparam UART_4.HalfDuplexEn = 0;
    defparam UART_4.HwTXEnSignal = 1;
    defparam UART_4.NumDataBits = 8;
    defparam UART_4.NumStopBits = 1;
    defparam UART_4.ParityType = 0;
    defparam UART_4.RXEnable = 1;
    defparam UART_4.TXEnable = 1;
    ...
    UART_v2_50_3 UART_1 (
        ...
        .rx_clk(Net_4358),
        .rx_data(Net_4359),
        .rx_interrupt(Net_4360),
        .tx(Net_4316),
        .tx_clk(Net_4361),
        .tx_data(Net_4362),
        .tx_en(Net_4363),
        .tx_interrupt(Net_4364));
    ...
    begin : mux_4
        reg  tmp__mux_4_reg;
        always @(Net_3257 or Net_181 or Net_323)
        begin
            case (Net_323)
                1'b0 :  tmp__mux_4_reg = Net_3257;
                1'b1 :  tmp__mux_4_reg = Net_181;
            endcase
        end
        assign Net_3258 = tmp__mux_4_reg;
    end
    // -- Mux end --
    ...
    UART_v2_50_6 UART_2 (
        ...
        .rx_clk(Net_4346),
        .rx_data(Net_4347),
        .rx_interrupt(Net_4348),
        .tx(Net_4315),
        .tx_clk(Net_4349),
        .tx_data(Net_4350),
        .tx_en(Net_4351),
        .tx_interrupt(Net_4352));
	...
	wire [0:0] tmpOE__P_front_right_net;
	wire [0:0] tmpIO_0__P_front_right_net;
	wire [0:0] tmpINTERRUPT_0__P_front_right_net;
	electrical [0:0] tmpSIOVREF__P_front_right_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("7a3ce083-5421-405b-ba24-c36efce5eef9"),
		  ...
		  .input_buffer_sel(2'b00))
		P_front_right
		 (.oe(tmpOE__P_front_right_net),
		  .y({1'b0}),
		  .fb({Net_3022}),
		  .io({tmpIO_0__P_front_right_net[0:0]}),
		  .siovref(tmpSIOVREF__P_front_right_net),
		  .interrupt({tmpINTERRUPT_0__P_front_right_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P_front_right_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__P_left_1_net;
	wire [0:0] tmpIO_0__P_left_1_net;
	wire [0:0] tmpINTERRUPT_0__P_left_1_net;
	electrical [0:0] tmpSIOVREF__P_left_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("113c546a-702d-4ef0-a0e0-2f80be33f0de"),
		  ...
		  .input_buffer_sel(2'b00))
		P_left_1
		 (.oe(tmpOE__P_left_1_net),
		  .y({1'b0}),
		  .fb({Net_174}),
		  .io({tmpIO_0__P_left_1_net[0:0]}),
		  .siovref(tmpSIOVREF__P_left_1_net),
		  .interrupt({tmpINTERRUPT_0__P_left_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P_left_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__P_left_2_net;
	wire [0:0] tmpIO_0__P_left_2_net;
	wire [0:0] tmpINTERRUPT_0__P_left_2_net;
	electrical [0:0] tmpSIOVREF__P_left_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("a65797af-a21e-4cf7-a0dd-1b5701af8bee"),
		  ...
		  .input_buffer_sel(2'b00))
		P_left_2
		 (.oe(tmpOE__P_left_2_net),
		  .y({1'b0}),
		  .fb({Net_175}),
		  .io({tmpIO_0__P_left_2_net[0:0]}),
		  .siovref(tmpSIOVREF__P_left_2_net),
		  .interrupt({tmpINTERRUPT_0__P_left_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P_left_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__P_right_2_net;
	wire [0:0] tmpIO_0__P_right_2_net;
	wire [0:0] tmpINTERRUPT_0__P_right_2_net;
	electrical [0:0] tmpSIOVREF__P_right_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("81b3d14e-8160-40d7-b8f3-997d503a0726"),
		  ...
		  .input_buffer_sel(2'b00))
		P_right_2
		 (.oe(tmpOE__P_right_2_net),
		  .y({1'b0}),
		  .fb({Net_177}),
		  .io({tmpIO_0__P_right_2_net[0:0]}),
		  .siovref(tmpSIOVREF__P_right_2_net),
		  .interrupt({tmpINTERRUPT_0__P_right_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P_right_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__P_right_1_net;
	wire [0:0] tmpIO_0__P_right_1_net;
	wire [0:0] tmpINTERRUPT_0__P_right_1_net;
	electrical [0:0] tmpSIOVREF__P_right_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0a485c91-328c-4317-8c01-86093c274d29"),
		  ...
		  .input_buffer_sel(2'b00))
		P_right_1
		 (.oe(tmpOE__P_right_1_net),
		  .y({1'b0}),
		  .fb({Net_176}),
		  .io({tmpIO_0__P_right_1_net[0:0]}),
		  .siovref(tmpSIOVREF__P_right_1_net),
		  .interrupt({tmpINTERRUPT_0__P_right_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P_right_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__P_front_left_net;
	wire [0:0] tmpIO_0__P_front_left_net;
	wire [0:0] tmpINTERRUPT_0__P_front_left_net;
	electrical [0:0] tmpSIOVREF__P_front_left_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		P_front_left
		 (.oe(tmpOE__P_front_left_net),
		  .y({1'b0}),
		  .fb({Net_2890}),
		  .io({tmpIO_0__P_front_left_net[0:0]}),
		  .siovref(tmpSIOVREF__P_front_left_net),
		  .interrupt({tmpINTERRUPT_0__P_front_left_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P_front_left_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_2912 = 1'h0;

    // -- Mux start --
    if (1)
    begin : mux_3
        reg  tmp__mux_3_reg;
        always @(Net_2912 or Net_2890 or Net_2889)
        begin
            case (Net_2889)
                1'b0 :  tmp__mux_3_reg = Net_2912;
                1'b1 :  tmp__mux_3_reg = Net_2890;
            endcase
        end
        assign Net_2913 = tmp__mux_3_reg;
    end
    // -- Mux end --

    assign Net_2910 = 1'h0;

    // -- Mux start --
    if (1)
    begin : mux_2
        reg  tmp__mux_2_reg;
        always @(Net_2910 or Net_3022 or Net_2889)
        begin
            case (Net_2889)
                1'b0 :  tmp__mux_2_reg = Net_2910;
                1'b1 :  tmp__mux_2_reg = Net_3022;
            endcase
        end
        assign Net_2911 = tmp__mux_2_reg;
    end
    // -- Mux end --
    ...
    defparam MODE.NumOutputs = 1;

    assign Net_2599 = 1'h0;

    // -- Mux start --
    if (1)
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_2599 or Net_2891 or Net_2889)
        begin
            case (Net_2889)
                1'b0 :  tmp__mux_1_reg = Net_2599;
                1'b1 :  tmp__mux_1_reg = Net_2891;
            endcase
        end
        assign Net_234 = tmp__mux_1_reg;
    end
    // -- Mux end --
	...
	wire [0:0] tmpOE__P_front_net;
	wire [0:0] tmpIO_0__P_front_net;
	wire [0:0] tmpINTERRUPT_0__P_front_net;
	electrical [0:0] tmpSIOVREF__P_front_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("6ab4de01-1a1a-43af-86fb-f57b7484a7cd"),
		  ...
		  .input_buffer_sel(2'b00))
		P_front
		 (.oe(tmpOE__P_front_net),
		  .y({1'b0}),
		  .fb({Net_2891}),
		  .io({tmpIO_0__P_front_net[0:0]}),
		  .siovref(tmpSIOVREF__P_front_net),
		  .interrupt({tmpINTERRUPT_0__P_front_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P_front_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_3257 = 1'h0;

    CyControlReg_v1_80 STOP (
        .clock(1'b0),
        .control_0(Net_323),
        .control_1(Net_3273),
        .control_2(Net_3274),
        ...
        .control_7(Net_3279),
        .reset(1'b0));
    defparam STOP.Bit0Mode = 0;
    defparam STOP.Bit1Mode = 0;
    defparam STOP.Bit2Mode = 0;
    defparam STOP.Bit3Mode = 0;
    defparam STOP.Bit4Mode = 0;
    defparam STOP.Bit5Mode = 0;
    defparam STOP.Bit6Mode = 0;
    defparam STOP.Bit7Mode = 0;
    defparam STOP.BitValue = 1;
    defparam STOP.BusDisplay = 0;
    defparam STOP.ExtrReset = 0;
    defparam STOP.NumOutputs = 1;

	wire [0:0] tmpOE__P_back_left_net;
	wire [0:0] tmpIO_0__P_back_left_net;
	wire [0:0] tmpINTERRUPT_0__P_back_left_net;
	electrical [0:0] tmpSIOVREF__P_back_left_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("9caca911-9509-4d64-9add-55d1bbeaae3e"),
		  ...
		  .input_buffer_sel(2'b00))
		P_back_left
		 (.oe(tmpOE__P_back_left_net),
		  .y({1'b0}),
		  .fb({Net_3114}),
		  .io({tmpIO_0__P_back_left_net[0:0]}),
		  .siovref(tmpSIOVREF__P_back_left_net),
		  .interrupt({tmpINTERRUPT_0__P_back_left_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P_back_left_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__P_back_net;
	wire [0:0] tmpIO_0__P_back_net;
	wire [0:0] tmpINTERRUPT_0__P_back_net;
	electrical [0:0] tmpSIOVREF__P_back_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("b084f5c5-4c20-4f0b-af93-05a9316ccdf3"),
		  ...
		  .input_buffer_sel(2'b00))
		P_back
		 (.oe(tmpOE__P_back_net),
		  .y({1'b0}),
		  .fb({Net_3101}),
		  .io({tmpIO_0__P_back_net[0:0]}),
		  .siovref(tmpSIOVREF__P_back_net),
		  .interrupt({tmpINTERRUPT_0__P_back_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P_back_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__P_back_right_net;
	wire [0:0] tmpIO_0__P_back_right_net;
	wire [0:0] tmpINTERRUPT_0__P_back_right_net;
	electrical [0:0] tmpSIOVREF__P_back_right_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("792c9118-ccb4-4b75-ae7f-3af673aad9ed"),
		  ...
		  .input_buffer_sel(2'b00))
		P_back_right
		 (.oe(tmpOE__P_back_right_net),
		  .y({1'b0}),
		  .fb({Net_3112}),
		  .io({tmpIO_0__P_back_right_net[0:0]}),
		  .siovref(tmpSIOVREF__P_back_right_net),
		  .interrupt({tmpINTERRUPT_0__P_back_right_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P_back_right_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    begin : mux_5
        reg  tmp__mux_5_reg;
        always @(Net_3100 or Net_3101 or Net_2889)
        begin
            case (Net_2889)
                1'b0 :  tmp__mux_5_reg = Net_3100;
                1'b1 :  tmp__mux_5_reg = Net_3101;
            endcase
        end
        assign Net_3618 = tmp__mux_5_reg;
    end
    // -- Mux end --

    assign Net_3100 = 1'h0;
    ...
    defparam LED.BitValue = 1;
    defparam LED.BusDisplay = 0;
    defparam LED.ExtrReset = 0;
    defparam LED.NumOutputs = 1;

    // -- Mux start --
    if (1)
    begin : mux_6
        reg  tmp__mux_6_reg;
        always @(Net_3111 or Net_3112 or Net_2889)
        begin
            case (Net_2889)
                1'b0 :  tmp__mux_6_reg = Net_3111;
                1'b1 :  tmp__mux_6_reg = Net_3112;
            endcase
        end
        assign Net_3098 = tmp__mux_6_reg;
    end
    // -- Mux end --

    assign Net_3111 = 1'h0;

    // -- Mux start --
    if (1)
    begin : mux_7
        reg  tmp__mux_7_reg;
        always @(Net_3113 or Net_3114 or Net_2889)
        begin
            case (Net_2889)
                1'b0 :  tmp__mux_7_reg = Net_3113;
                1'b1 :  tmp__mux_7_reg = Net_3114;
            endcase
        end
        assign Net_3097 = tmp__mux_7_reg;
    end
    // -- Mux end --

    assign Net_3113 = 1'h0;
